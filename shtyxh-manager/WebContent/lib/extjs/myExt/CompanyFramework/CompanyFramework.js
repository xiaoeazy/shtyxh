Ext.namespace('CompanyFramework');
CompanyFramework.CompanyFrameworkPanel= function(config) {
	Ext.applyIf(this, config);
	this.initUIComponents();
	CompanyFramework.CompanyFrameworkPanel.superclass.constructor.call(this);
};


Ext.extend(CompanyFramework.CompanyFrameworkPanel, Ext.Panel, {
	initUIComponents : function() {
		var me = this;
		var mainId = me.mainId+"_CompanyFramework";
			  ...
			  buttons:[{
				  width:50,
					...
					handler : function(button, event) {
						me.saveCompanyFramework(me,formpanel,mainId);
					}
			  },{
				  width:50,
					text : '重置',
	...
	saveCompanyFramework:function(me,formpanel,mainId){

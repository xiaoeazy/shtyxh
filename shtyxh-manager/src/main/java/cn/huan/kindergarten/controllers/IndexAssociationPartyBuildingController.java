...
public class IndexAssociationPartyBuildingController extends IndexBaseController{
    ...
    public ModelAndView associationPartyBuilding(HttpServletRequest request) {
    	ModelAndView mv = new ModelAndView(getViewPath() + "/index/associationPartyBuilding/associationPartyBuilding");
        ...
        loadNavigation(mv, requestContext,IndexController.CH_DJHD);
        loadSysConfig(mv);
        return mv;
    }
	 ...
	 @RequestMapping(value = {"/index/djhd/typeList"})
	    ...
	    public ModelAndView associationPartyBuildingTypeList(Long typeid, @RequestParam(defaultValue = DEFAULT_PAGE) int page,
	    	...
	    	ModelAndView mv = new ModelAndView(getViewPath() + "/index/associationPartyBuilding/associationPartyBuildingTypeList");
	    	IRequest requestContext = createRequestContext(request);
	    	if(typeid==null)
	    ...
	    public ModelAndView associationDynamicsDetail(Long id,HttpServletRequest request) throws E404Excetion {
	    	ModelAndView mv = new ModelAndView(getViewPath() + "/index/associationPartyBuilding/associationPartyBuildingNewsDetail");
	        IRequest requestContext = createRequestContext(request);
